...
public class VipsSeparatorGraphicsDetector extends JPanel implements VipsSeparatorDetector {
	...
	public VipsSeparatorGraphicsDetector(int width, int height) {
		...
		try
		{
			...
			System.out.print("VipsSeparatorGraphicsDetector construction error");
		}
	}
	...
	public void addVisualBlock(VipsBlock vipsBlock)
	{
		...
		int x= elementBox.getAbsoluteContentX();
		int y = elementBox.getAbsoluteContentY();
		int width = elementBox.getContentWidth();
		int height = elementBox.getContentHeight();
		Rectangle rect = new Rectangle(x,y,width,height);

		OperateImage operateImage = new OperateImage(x,y,width,height);
		String srcPath = folder+"/page.png";

		String outPath = folder+"/subPage/"+index+".png";
		index++;
		operateImage.setSrcpath(srcPath);
		operateImage.setSubpath(outPath);
//		try {
//			BufferedImage subPage = operateImage.cut();
//			vipsBlock.setImage(subPage);
//			vipsBlock.setSubPagePath(outPath);
//		}catch (IOException e){
