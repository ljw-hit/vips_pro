...
public class VisualStructure {
	...
	/*check visual structure if or not leaf */
	static public void checkLeaf(VisualStructure visualStructure){
		if(visualStructure.getChildrenVisualStructures().isEmpty()){
			visualStructure.setLeaf(true);
		}
